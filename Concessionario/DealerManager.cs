...
namespace Concessionario
{
    class DealerManager
    {
        ...
        internal static void InsertVehicles()
        {
            ...
            do
            {
                Console.WriteLine("Quale tipo di veicolo vuoi inserire?");
        ...
        private static Car ChiediDatiAuto()
        {
            ...
            while (!int.TryParse(Console.ReadLine(), out numeroPorte) || numeroPorte < 3 || numeroPorte > 5)
            {
        ...
        private static Motocycle ChiediDatiMoto()
        {
            ...
            while (!int.TryParse(Console.ReadLine(), out annoProduzione) || annoProduzione < 1910 || annoProduzione > 2021)
            {
                Console.WriteLine("Inserire valore corretto!");
            }
